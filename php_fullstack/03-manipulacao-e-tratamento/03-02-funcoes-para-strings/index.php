...
var_dump([
    "string" => $string,
    "strlen" => strlen($string), // conta caractere como acentos, espaços
    "mb_strlen" => mb_strlen($string), //uso multibyte - não conta caractere
    "substr" => substr($string, "9"),
    "mb_substr" => mb_substr($string, "9"),
    "strtoupper" => strtoupper($string), // transforma em maiuscula mas nao as com acentuação
    "mb_strtoupper" => mb_strtoupper($string), // transforma tudo inclusive com acentuação
...
var_dump([
    ...
    "mb_convert_case UPPER" => mb_convert_case($mbString, MB_CASE_UPPER), // maiuscula
    "mb_convert_case LOWER" => mb_convert_case($mbString, MB_CASE_LOWER), // minuscula
    "mb_convert_case TITLE" => mb_convert_case($mbString, MB_CASE_TITLE), // primeira maiuscula
]);
...
var_dump([
    ...
    "mb_strpos" => mb_strpos($mbReplace, ", "), // posicao caractere
    "mb_strrpos" => mb_strrpos($mbReplace, ", "), 
    "mb_substr" => mb_substr($mbReplace, 40+2, 14), // subsitui
    "mb_strstr" => mb_strstr($mbReplace,", ", true),
    "mb_strrchr" => mb_strrchr($mbReplace,", ", true), // ulima ocorrencia
]);
